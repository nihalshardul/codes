...
CreateCommandTag(Node *parsetree)
{
	...
	switch (nodeTag(parsetree))
	{
		...
		case T_CreateDomainStmt:
			tag = "17153 => CREATE DOMAIN";
			break;

		case T_CreateSchemaStmt:
			tag = "17153 => CREATE SCHEMA";
			break;

		case T_CreateStmt:
			tag = "17153 => CREATE TABLE";
			break;

		case T_CreateTableSpaceStmt:
			tag = "17153 => CREATE TABLESPACE";
			break;

		case T_DropTableSpaceStmt:
			tag = "17153 => DROP TABLESPACE";
			break;

		case T_AlterTableSpaceOptionsStmt:
			tag = "17153 => ALTER TABLESPACE";
			break;

		case T_CreateExtensionStmt:
			tag = "17153 => CREATE EXTENSION";
			break;

		case T_AlterExtensionStmt:
			tag = "17153 => ALTER EXTENSION";
			break;
