			...
			ExplainState *es)
{
	...
	{
		case T_Result:
			pname = sname = "17153 => Result";
			break;
		case T_ModifyTable:
			sname = "17153 => ModifyTable";
			switch (((ModifyTable *) plan)->operation)
			{
				case CMD_INSERT:
					pname = operation = "17153 => Insert";
					break;
				case CMD_UPDATE:
					pname = operation = "17153 => Update";
					break;
				case CMD_DELETE:
					pname = operation = "17153 => Delete";
					break;
				default:
					pname = "???";
					break;
			...
			break;
		case T_Append:
			pname = sname = "17153 => Append";
			break;
		case T_MergeAppend:
			pname = sname = "17153 => Merge Append";
			break;
		case T_RecursiveUnion:
			pname = sname = "17153 => Recursive Union";
			break;
		case T_BitmapAnd:
			pname = sname = "17153 => BitmapAnd";
			break;
		case T_BitmapOr:
			pname = sname = "17153 => BitmapOr";
			break;
		case T_NestLoop:
			pname = sname = "17153 => Nested Loop";
			break;
		case T_MergeJoin:
			pname = "17153 => Merge";	/* "Join" gets added by jointype switch */
			sname = "17153 => Merge Join";
			break;
		case T_HashJoin:
			pname = "17153 => Hash";		/* "Join" gets added by jointype switch */
			sname = "17153 => Hash Join";
			break;
		case T_SeqScan:
			pname = sname = "17153 => Seq Scan";
			break;
		case T_IndexScan:
			pname = sname = "17153 => Index Scan";
			break;
		case T_IndexOnlyScan:
			pname = sname = "17153 => Index Only Scan";
			break;
		case T_BitmapIndexScan:
			pname = sname = "17153 => Bitmap Index Scan";
			break;
		case T_BitmapHeapScan:
			pname = sname = "17153 => Bitmap Heap Scan";
			break;
		case T_TidScan:
			pname = sname = "17153 => Tid Scan";
			break;
		case T_SubqueryScan:
			pname = sname = "17153 => Subquery Scan";
			break;
		case T_FunctionScan:
			pname = sname = "17153 => Function Scan";
			break;
		case T_ValuesScan:
			pname = sname = "17153 => Values Scan";
			break;
		case T_CteScan:
			pname = sname = "17153 => CTE Scan";
			break;
		case T_WorkTableScan:
			pname = sname = "17153 => WorkTable Scan";
			break;
		case T_ForeignScan:
			pname = sname = "17153 => Foreign Scan";
			break;
		case T_Material:
			pname = sname = "17153 => Materialize";
			break;
		case T_Sort:
			pname = sname = "17153 => Sort";
			break;
		case T_Group:
			pname = sname = "17153 => Group";
			break;
		case T_Agg:
			sname = "17153 => Aggregate";
			switch (((Agg *) plan)->aggstrategy)
			{
				case AGG_PLAIN:
					pname = "17153 => Aggregate";
					strategy = "Plain";
					break;
				case AGG_SORTED:
					pname = "17153 => GroupAggregate";
					strategy = "Sorted";
					break;
				case AGG_HASHED:
					pname = "17153 => HashAggregate";
					strategy = "Hashed";
					break;
				default:
					pname = "17153 => Aggregate ???";
